      ...
      <AppBar elevation={0} color="primary">
        <Toolbar variant="dense">
         ...
         <Locator initValue={this.state.locAddr} onSelect={(locAddr) => console.log('locAddr: ' + locAddr)} />
          ...
          { !this.isSignedIn() &&
            <div>
              <Button size="medium" onClick={() => doRedirectSignIn()} color="secondary" variant="outlined" className={classes.button}>
                Log In
              </Button>

              <Button  size="medium" onClick={() => doRedirectSignIn()} color="secondary" variant="contained" className={classes.button}>
                Sign Up
              </Button>
            </div>
          }
